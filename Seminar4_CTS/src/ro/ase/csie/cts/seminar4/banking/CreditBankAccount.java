...
public class CreditBankAccount extends BankAccount implements Receivable {
	...
	public CreditBankAccount(NotificationService notificationService, String iban, Person accountHolder) {
	...
	public static CreditBankAccount createCreditBankAccountWithoutBalance(NotificationService ns, String iban,
