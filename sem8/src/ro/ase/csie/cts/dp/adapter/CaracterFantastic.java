...
public class CaracterFantastic extends ACMECaracterJoc {
    ...
    public void esteLovit(int puncte) {
        System.out.println(String.format("%s este lovit si pierde %d puncte", nume, puncteViata));
    }

    @Override
    public void seVindeca(int puncte) {
        System.out.println(String.format("%s se vindeca si recupereaza %d puncte", nume, puncteViata));
    }
}
